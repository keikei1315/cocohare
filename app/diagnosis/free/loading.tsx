  ...
  return (
    <div style={{ backgroundColor: '#FFF9F5', minHeight: '100vh', padding: '24px 16px' }}>
      ...
      <div style={{ maxWidth: '480px', margin: '0 auto', display: 'flex', flexDirection: 'column', gap: '20px' }}>
        <div className="sk" style={{ width: '80px', height: '80px', borderRadius: '50%', backgroundColor: '#EDE5DC', margin: '0 auto' }} />
        <div className="sk" style={{ width: '200px', height: '24px', borderRadius: '8px', backgroundColor: '#EDE5DC', margin: '0 auto' }} />
